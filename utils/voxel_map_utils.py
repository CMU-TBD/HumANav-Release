...
class VoxelMap(object):
    ...
    def compute_voxel_function(self, position_nk2, invalid_value=100.):
        ...
        data11_nk = np.take(self.voxel_function_mn, np.take(
            voxel_indices_int64_nk4, [1, 0], axis=2), axis=2)
        data21_nk = np.take(self.voxel_function_mn, np.take(
            voxel_indices_int64_nk4, [1, 2], axis=2), axis=2)
        data12_nk = np.take(self.voxel_function_mn, np.take(
            voxel_indices_int64_nk4, [3, 0], axis=2), axis=2)
        data22_nk = np.take(self.voxel_function_mn, np.take(
            voxel_indices_int64_nk4, [3, 2], axis=2), axis=2)
