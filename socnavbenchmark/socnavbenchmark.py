...
sys.path.append(os.path.abspath("../obstacles/"))
...
def plot_images(rgb_image_1mk3, depth_image_1mk1, environment, camera_pos_13, humans, filename):
...
def test_socnavbenchmark(num_humans):
    """
